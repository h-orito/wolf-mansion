      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            messageType: "message-public-system",
            content:
              "[01楽]楽天家 ゲルトは、新しい顔がもらえなくなってしまい、顔がふやけて衰弱死した。",
          },
          {
            type: "message",
            messageType: "message-private-system",
        ...
        items: [
          {
            type: "text",
            content:
              "あなたが処刑されると、その日あなたに投票した人は開票後に「不敬」が付与されます。",
          },
          {
            type: "text",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            messageType: "message-private-system",
            content:
              "[02長]村長 ヴァルターは、投票の恨みを晴らすべく、[03娘]村娘 パメラを殴打した。",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            type: "text",
            content:
              "1回だけ1人を指定し、「呪縛符」状態にすることができます（対象には通知されません）。",
          },
          {
            type: "text",
            content:
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            type: "text",
            content:
              "1回だけ1人を指定し、「反呪符」状態にすることができます（対象には通知されません）。",
          },
          {
            type: "text",
            content:
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            type: "text",
            content:
              "ゴーレム：2回まで「瞑想」を使用可能。使用中は自身に護衛効果が付き、得票数が0になる",
          },
          {
            type: "text",
          ...
          },
          {
            type: "text",
            content:
              "消音者：一度だけ、翌日の足音を全て聞こえない状態にすることができる（黒箱の足音版）",
          },
          {
            type: "text",
          ...
          },
          {
            type: "text",
            content:
              "火災報知器：リア充や爆弾魔が生存している場合、朝に専用のメッセージが表示される",
          },
          {
            type: "text",
