...
export type UnimplementedCamp = { name: string; skills: string[] };

export const unimplementedSkills: UnimplementedCamp[] = [
  {
    name: "村人陣営",
    skills: [
      "直感者：導師の勝敗判定陣営版",
      "幽霊：2日目に死亡する。霊界から投票できる",
      "ヒステリー：同じ人が3回自分の部屋で足音を鳴らすと鳴らした人が死亡する",
      "目撃者：自分の部屋を通過した人の役職を知ることができる",
      "潔癖症：自分の部屋で足音が響いたら死亡",
      "塗装工：任意の部屋にペンキを塗ることができ、その部屋の通過者が朝に公表される",
      "聖母：一度だけ自分の命を犠牲にして任意の人を生き返らせることができる",
      "夜逃屋：一度だけ、空き部屋に移動できる（永続）",
      "イタコ：墓下会話を、誰が発言したかわからない状態で覗くことができる",
      "侍：護衛能力。護衛成功した場合襲撃者と相打ちで両方死亡する。",
      "反撃者：襲撃されると自身が襲撃死、襲撃者が反撃死する",
      "マンボウ：自分に能力を使用されたり自分の部屋で足音が鳴ると死亡するが、3回までマンボウとして生き返ることができる",
      "名探偵：1回だけ一人を指定して人狼系もしくは妖狐系だった場合翌日公表することができる。外れていたら死ぬ。",
      "逆張りオタク：自分が投票した人が死亡すると自分も死亡する",
      "波動者：一度だけ、対象のステータスをすべて消せる",
      "愚者：思い込み賢者。編成されている役職からランダムで結果が得られる",
      "音波者：足音を鳴らした人の役職構成を知ることができる",
      "ゴーレム：2回まで「瞑想」を使用可能。使用中は自身に護衛効果が付き、得票数が0になる",
      "聖痕者：絶対人狼のように、出現すると聖痕者が誰であるか公開される",
      "大魔道士：転生でしか出現しない。賢者と導師の能力を持つ",
      ...
      "脈々者：毎日、現在の村人カウント数がわかる",
      "無罪者：一度だけ、指定した人の得票数を0にできる",
    ],
  },
  {
    name: "人狼陣営",
    skills: [
      ...
      "冥狼：墓下会話を、誰が発言したかわからない状態で覗くことができる狼",
      "鎌鼬：一度だけ足音なしで襲撃できる",
      "鰐狼：襲撃耐性がある対象しか噛めない狼",
      "牙狼：襲撃耐性を貫通する。護衛は有効",
      "覚醒狂人：覚醒前は能力なしだが、自分の部屋で足音が響くとC国狂人になる狂人",
      "？？？：一度だけ、対象の恋絆、狐憑き、信念を除去し、狂気を付与して蘇生させる",
      "尸術師：保険屋の人狼陣営版。狂気を付与する",
      "消音者：一度だけ、翌日の足音を全て聞こえない状態にすることができる（黒箱の足音版）",
      "爆弾岩：無惨死すると自分を中心に3*3の人が爆死する",
      "共犯者：人狼陣営の共鳴者",
      "囁狂人：囁き発言ができるが囁き発言が見えない狂人",
      "？？？：保険者の黙狼蘇生版",
      "悪徳弁護士：弁護士の人狼陣営版",
      "反復者：昨晩響いた足音を選び、翌日同じ足音を鳴らせる",
      "予告者：「次回、xx死す」を表示し、翌日に貫通襲撃死させられる",
  ...
  },
  {
    ...
    skills: [
      ...
      "縛狐：自身の死亡時に能力で指定していた人を道連れにする妖狐",
      "叡狐：足音を鳴らした部屋の役職構成を占える妖狐",
      "浮狐：爆死・罠死・雑魚死しない",
      "狐火：一度だけ、対象の恋絆、狂気、信念を除去し、狐憑きを付与して蘇生させる",
      "？？？：保険者の妖狐蘇生版",
      "結界師：2回まで呪殺護衛できる。逆呪殺は護衛できない",
      "仔狐：申し子の狐陣営版",
      "天狗：一度だけ直線上の相手を選んで襲撃できる",
      "憑狐：魅惑の人魚の狐憑き版",
    ],
  },
  {
    ...
    skills: [
      ...
      "般若：恋人発言が聞こえる。自分が生存かつ恋人陣営の全滅が勝利条件",
      "イケボ：発言がオシャレな文体になる",
      "生肉：N日以内に襲撃死すると勝利",
      "？？？：対象と同じ陣営の役職に転生できる",
      "応援隊：1日目に指定した人が勝利していたら勝利",
      "復讐者：1日目に指定した人が死亡かつ自分が最後まで生存していたら勝利",
      "画竜点睛者：愉快犯に転生できる。転生しないと敗北",
      "リア充絶対殺すマン：マタギの恋絆版",
      "転勤族：毎日空き部屋に移動する",
      "現場猫：指揮官の愉快犯陣営版",
      "切磋琢磨：1日目に指定した人と自分が両方最後まで生存していたら勝利",
      "後継者：王族が死亡していると、王族に役職変化する",
      "迷惑系リア充：転生でしか出現しない。爆発すると周囲8部屋を蘇生＋強制転生させるリア充",
      "海苔弁：発言装飾系で、指定した相手の発言を常にcw状態にする",
      "魔法陣者：1回だけ魔法陣を設置でき、自分の部屋を通過した人を強制転生させる",
      "マッドサイエンティスト：蘇生者の強制転生版",
      "弾祭者：黒箱者に投票を隠された際生存していると、得票数上位5名が公開される",
