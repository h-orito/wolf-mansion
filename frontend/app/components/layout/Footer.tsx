...
export function Footer({ noAd = false }: { noAd?: boolean }) {
  ...
  return (
    <footer className="mt-4 w-full text-white">
      ...
      <Modal open={policyOpen} onClose={() => setPolicyOpen(false)} title="プライバシーポリシー">
...
function KampaContent() {
  return (
    <div className="space-y-3">
      <section>
        <h4 className="font-bold">Amazonほしい物リストから送る</h4>
...
function PrivacyPolicyContent() {
  return (
    <div className="space-y-2">
      ...
      <h4 className="font-bold">第1条（プライバシー情報）</h4>
      ...
      <h4 className="font-bold">第2条（プライバシー情報の収集方法）</h4>
      <ol className="list-decimal space-y-1 pl-5">
        <li>
      ...
      <h4 className="font-bold">第3条（プライバシー情報を収集・利用する目的）</h4>
      ...
      <h4 className="font-bold">第4条（利用目的の変更）</h4>
      <p>
      ...
      <h4 className="font-bold">第5条（個人情報の第三者提供）</h4>
      <p>
      ...
      <h4 className="font-bold">第6条（プライバシー情報の開示）</h4>
      <p>ID以外の情報については，原則として開示いたしません。</p>
      <h4 className="font-bold">第7条（プライバシー情報の訂正および削除）</h4>
      <ol className="list-decimal space-y-1 pl-5">
        <li>
      ...
      <h4 className="font-bold">第8条（プライバシー情報の利用停止等）</h4>
      <ol className="list-decimal space-y-1 pl-5">
        <li>
      ...
      <h4 className="font-bold">第9条（プライバシーポリシーの変更）</h4>
      <ol className="list-decimal space-y-1 pl-5">
        <li>
      ...
      <h4 className="font-bold">第10条（お問い合わせ窓口）</h4>
