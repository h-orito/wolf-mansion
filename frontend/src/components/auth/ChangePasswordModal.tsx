  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title='パスワード変更'>
      <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
        ...
        {/* 成功メッセージ */}
        {success && (
          <Alert variant='success'>パスワードが正常に変更されました。</Alert>
        )}
        ...
        <div>
          ...
          <input
            id='password'
            type='password'
            className='w-full rounded-md border border-gray-600 bg-gray-700 px-3 py-2 text-white placeholder-gray-400 focus:border-green-500 focus:outline-none'
        ...
        {/* 注意書き */}
        <div className='rounded-md bg-gray-800 p-3 text-xs text-gray-300'>
          <p>
            ※パスワードは忘れないようにしてください。パスワードを忘れた場合、アカウントの復旧はできません。
          </p>
        </div>
