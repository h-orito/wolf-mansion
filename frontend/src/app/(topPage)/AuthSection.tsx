      ...
      {isLoading ? (
        ...
        <div className='grid grid-cols-3'>
          ...
          <div
            ...
            className='flex w-full cursor-pointer flex-col gap-2 border border-[#333333] bg-[#0b162a] p-4 text-center text-xs leading-4 text-white hover:border-green-500'
          >
            <div className='flex justify-center'>
