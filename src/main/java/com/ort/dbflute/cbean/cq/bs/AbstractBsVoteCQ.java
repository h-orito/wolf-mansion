...
/**
 * The abstract condition-query of vote.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsVoteCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsVoteCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public HpSLCFunction<VoteCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, VoteCB.class);
    }
    ...
    public HpSLCFunction<VoteCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, VoteCB.class);
    }
    ...
    public HpSLCFunction<VoteCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, VoteCB.class);
    }
    ...
    public HpSLCFunction<VoteCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, VoteCB.class);
    }
    ...
    public HpSLCFunction<VoteCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, VoteCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;VoteCB&gt;() {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VoteCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, VoteCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        VoteCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(VoteCQ sq);

    protected VoteCB xcreateScalarConditionCB() {
        VoteCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected VoteCB xcreateScalarConditionPartitionByCB() {
        VoteCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected VoteCB newMyCB() {
        return new VoteCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return VoteCQ.class.getName(); }
