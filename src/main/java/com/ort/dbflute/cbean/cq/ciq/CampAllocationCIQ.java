...
public class CampAllocationCIQ extends AbstractBsCampAllocationCQ {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected BsCampAllocationCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public CampAllocationCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsCampAllocationCQ myCQ) {
    ...
    public String keepScalarCondition(CampAllocationCQ sq)
    ...
    protected String xinCB() { return CampAllocationCB.class.getName(); }
    protected String xinCQ() { return CampAllocationCQ.class.getName(); }
}
