...
/**
 * The abstract condition-query of WOLF_ALLOCATION.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsWolfAllocationCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWolfAllocationCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<WolfAllocationCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WolfAllocationCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WolfAllocationCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WolfAllocationCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WolfAllocationCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WolfAllocationCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WolfAllocationCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WolfAllocationCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WolfAllocationCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WolfAllocationCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WolfAllocationCB&gt;() {
     *     public void query(WolfAllocationCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WolfAllocationCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WolfAllocationCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        WolfAllocationCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(WolfAllocationCQ sq);

    protected WolfAllocationCB xcreateScalarConditionCB() {
        WolfAllocationCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected WolfAllocationCB xcreateScalarConditionPartitionByCB() {
        WolfAllocationCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<WolfAllocationCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WolfAllocationCB cb = new WolfAllocationCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "VILLAGE_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(WolfAllocationCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<WolfAllocationCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(WolfAllocationCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WolfAllocationCB cb = new WolfAllocationCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "VILLAGE_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(WolfAllocationCQ sq);
     ...
     */
    public void myselfExists(SubQuery<WolfAllocationCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        WolfAllocationCB cb = new WolfAllocationCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(WolfAllocationCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected WolfAllocationCB newMyCB() {
        return new WolfAllocationCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return WolfAllocationCQ.class.getName(); }
