...
/**
 * The abstract condition-query of VILLAGE_PLAYER_ROOM_HISTORY.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsVillagePlayerRoomHistoryCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsVillagePlayerRoomHistoryCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param villagePlayerRoomHistoryId The value of villagePlayerRoomHistoryId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setVillagePlayerRoomHistoryId_Equal(Integer villagePlayerRoomHistoryId) {
        doSetVillagePlayerRoomHistoryId_Equal(villagePlayerRoomHistoryId);
    }

    protected void doSetVillagePlayerRoomHistoryId_Equal(Integer villagePlayerRoomHistoryId) {
        regVillagePlayerRoomHistoryId(CK_EQ, villagePlayerRoomHistoryId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * VILLAGE_PLAYER_ROOM_HISTORY_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param villagePlayerRoomHistoryId The value of villagePlayerRoomHistoryId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setVillagePlayerRoomHistoryId_NotEqual(Integer villagePlayerRoomHistoryId) {
        doSetVillagePlayerRoomHistoryId_NotEqual(villagePlayerRoomHistoryId);
    }

    protected void doSetVillagePlayerRoomHistoryId_NotEqual(Integer villagePlayerRoomHistoryId) {
        regVillagePlayerRoomHistoryId(CK_NES, villagePlayerRoomHistoryId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * VILLAGE_PLAYER_ROOM_HISTORY_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param villagePlayerRoomHistoryId The value of villagePlayerRoomHistoryId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setVillagePlayerRoomHistoryId_GreaterThan(Integer villagePlayerRoomHistoryId) {
        regVillagePlayerRoomHistoryId(CK_GT, villagePlayerRoomHistoryId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * VILLAGE_PLAYER_ROOM_HISTORY_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param villagePlayerRoomHistoryId The value of villagePlayerRoomHistoryId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setVillagePlayerRoomHistoryId_LessThan(Integer villagePlayerRoomHistoryId) {
        regVillagePlayerRoomHistoryId(CK_LT, villagePlayerRoomHistoryId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * VILLAGE_PLAYER_ROOM_HISTORY_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param villagePlayerRoomHistoryId The value of villagePlayerRoomHistoryId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setVillagePlayerRoomHistoryId_GreaterEqual(Integer villagePlayerRoomHistoryId) {
        regVillagePlayerRoomHistoryId(CK_GE, villagePlayerRoomHistoryId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * VILLAGE_PLAYER_ROOM_HISTORY_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param villagePlayerRoomHistoryId The value of villagePlayerRoomHistoryId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setVillagePlayerRoomHistoryId_LessEqual(Integer villagePlayerRoomHistoryId) {
        regVillagePlayerRoomHistoryId(CK_LE, villagePlayerRoomHistoryId);
    }
     ...
     * VILLAGE_PLAYER_ROOM_HISTORY_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param minNumber The min number of villagePlayerRoomHistoryId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of villagePlayerRoomHistoryId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setVillagePlayerRoomHistoryId_RangeOf(Integer minNumber, Integer maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setVillagePlayerRoomHistoryId_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     */
    protected void setVillagePlayerRoomHistoryId_RangeOf(Integer minNumber, Integer maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueVillagePlayerRoomHistoryId(), "VILLAGE_PLAYER_ROOM_HISTORY_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * VILLAGE_PLAYER_ROOM_HISTORY_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param villagePlayerRoomHistoryIdList The collection of villagePlayerRoomHistoryId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setVillagePlayerRoomHistoryId_InScope(Collection<Integer> villagePlayerRoomHistoryIdList) {
        doSetVillagePlayerRoomHistoryId_InScope(villagePlayerRoomHistoryIdList);
    }

    protected void doSetVillagePlayerRoomHistoryId_InScope(Collection<Integer> villagePlayerRoomHistoryIdList) {
        regINS(CK_INS, cTL(villagePlayerRoomHistoryIdList), xgetCValueVillagePlayerRoomHistoryId(), "VILLAGE_PLAYER_ROOM_HISTORY_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * VILLAGE_PLAYER_ROOM_HISTORY_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param villagePlayerRoomHistoryIdList The collection of villagePlayerRoomHistoryId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setVillagePlayerRoomHistoryId_NotInScope(Collection<Integer> villagePlayerRoomHistoryIdList) {
        doSetVillagePlayerRoomHistoryId_NotInScope(villagePlayerRoomHistoryIdList);
    }

    protected void doSetVillagePlayerRoomHistoryId_NotInScope(Collection<Integer> villagePlayerRoomHistoryIdList) {
        regINS(CK_NINS, cTL(villagePlayerRoomHistoryIdList), xgetCValueVillagePlayerRoomHistoryId(), "VILLAGE_PLAYER_ROOM_HISTORY_ID");
    }
     ...
     * VILLAGE_PLAYER_ROOM_HISTORY_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     */
    public void setVillagePlayerRoomHistoryId_IsNull() { regVillagePlayerRoomHistoryId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * VILLAGE_PLAYER_ROOM_HISTORY_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     */
    public void setVillagePlayerRoomHistoryId_IsNotNull() { regVillagePlayerRoomHistoryId(CK_ISNN, DOBJ); }

    protected void regVillagePlayerRoomHistoryId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueVillagePlayerRoomHistoryId(), "VILLAGE_PLAYER_ROOM_HISTORY_ID"); }
    protected abstract ConditionValue xgetCValueVillagePlayerRoomHistoryId();
     ...
     */
    public HpSLCFunction<VillagePlayerRoomHistoryCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, VillagePlayerRoomHistoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VillagePlayerRoomHistoryCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, VillagePlayerRoomHistoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VillagePlayerRoomHistoryCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, VillagePlayerRoomHistoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VillagePlayerRoomHistoryCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, VillagePlayerRoomHistoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VillagePlayerRoomHistoryCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, VillagePlayerRoomHistoryCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;VillagePlayerRoomHistoryCB&gt;() {
     *     public void query(VillagePlayerRoomHistoryCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VillagePlayerRoomHistoryCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, VillagePlayerRoomHistoryCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        VillagePlayerRoomHistoryCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(VillagePlayerRoomHistoryCQ sq);

    protected VillagePlayerRoomHistoryCB xcreateScalarConditionCB() {
        VillagePlayerRoomHistoryCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected VillagePlayerRoomHistoryCB xcreateScalarConditionPartitionByCB() {
        VillagePlayerRoomHistoryCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<VillagePlayerRoomHistoryCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        VillagePlayerRoomHistoryCB cb = new VillagePlayerRoomHistoryCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "VILLAGE_PLAYER_ROOM_HISTORY_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(VillagePlayerRoomHistoryCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<VillagePlayerRoomHistoryCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(VillagePlayerRoomHistoryCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        VillagePlayerRoomHistoryCB cb = new VillagePlayerRoomHistoryCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "VILLAGE_PLAYER_ROOM_HISTORY_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(VillagePlayerRoomHistoryCQ sq);
     ...
     */
    public void myselfExists(SubQuery<VillagePlayerRoomHistoryCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        VillagePlayerRoomHistoryCB cb = new VillagePlayerRoomHistoryCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(VillagePlayerRoomHistoryCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected VillagePlayerRoomHistoryCB newMyCB() {
        return new VillagePlayerRoomHistoryCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return VillagePlayerRoomHistoryCQ.class.getName(); }
