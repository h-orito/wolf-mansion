...
public class BsVillageSettingsCQ extends AbstractBsVillageSettingsCQ {
    ...
    protected ConditionValue _isAvailableAction;
    public ConditionValue xdfgetIsAvailableAction()
    { if (_isAvailableAction == null) { _isAvailableAction = nCV(); }
      return _isAvailableAction; }
    protected ConditionValue xgetCValueIsAvailableAction() { return xdfgetIsAvailableAction(); }
     ...
     * @return this. (NotNull)
     */
    public BsVillageSettingsCQ addOrderBy_IsAvailableAction_Asc() { regOBA("IS_AVAILABLE_ACTION"); return this; }
