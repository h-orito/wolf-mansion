...
public abstract class AbstractBsVillageSettingsCQ extends AbstractConditionQuery {
     ...
     */
    public void setIsOpenVote_Equal_AsFlg(CDef.Flg cdef) {
        doSetIsOpenVote_Equal(cdef != null ? Boolean.valueOf(cdef.code()) : null);
    }
     ...
     * はい: 有効を示す
     */
    public void setIsOpenVote_Equal_True() {
        doSetIsOpenVote_Equal(Boolean.valueOf(CDef.Flg.True.code()));
    }
     ...
     * いいえ: 無効を示す
     */
    public void setIsOpenVote_Equal_False() {
        doSetIsOpenVote_Equal(Boolean.valueOf(CDef.Flg.False.code()));
    }

    protected void doSetIsOpenVote_Equal(Boolean isOpenVote) {
        regIsOpenVote(CK_EQ, isOpenVote);
    }
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setIsPossibleSkillRequest_Equal_AsFlg(CDef.Flg cdef) {
        doSetIsPossibleSkillRequest_Equal(cdef != null ? Boolean.valueOf(cdef.code()) : null);
    }
     ...
     * はい: 有効を示す
     */
    public void setIsPossibleSkillRequest_Equal_True() {
        doSetIsPossibleSkillRequest_Equal(Boolean.valueOf(CDef.Flg.True.code()));
    }
     ...
     * いいえ: 無効を示す
     */
    public void setIsPossibleSkillRequest_Equal_False() {
        doSetIsPossibleSkillRequest_Equal(Boolean.valueOf(CDef.Flg.False.code()));
    }

    protected void doSetIsPossibleSkillRequest_Equal(Boolean isPossibleSkillRequest) {
        regIsPossibleSkillRequest(CK_EQ, isPossibleSkillRequest);
    }
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setIsAvailableSpectate_Equal_AsFlg(CDef.Flg cdef) {
        doSetIsAvailableSpectate_Equal(cdef != null ? Boolean.valueOf(cdef.code()) : null);
    }
     ...
     * はい: 有効を示す
     */
    public void setIsAvailableSpectate_Equal_True() {
        doSetIsAvailableSpectate_Equal(Boolean.valueOf(CDef.Flg.True.code()));
    }
     ...
     * いいえ: 無効を示す
     */
    public void setIsAvailableSpectate_Equal_False() {
        doSetIsAvailableSpectate_Equal(Boolean.valueOf(CDef.Flg.False.code()));
    }

    protected void doSetIsAvailableSpectate_Equal(Boolean isAvailableSpectate) {
        regIsAvailableSpectate(CK_EQ, isAvailableSpectate);
    }
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setIsAvailableCommit_Equal_AsFlg(CDef.Flg cdef) {
        doSetIsAvailableCommit_Equal(cdef != null ? Boolean.valueOf(cdef.code()) : null);
    }
     ...
     * はい: 有効を示す
     */
    public void setIsAvailableCommit_Equal_True() {
        doSetIsAvailableCommit_Equal(Boolean.valueOf(CDef.Flg.True.code()));
    }
     ...
     * いいえ: 無効を示す
     */
    public void setIsAvailableCommit_Equal_False() {
        doSetIsAvailableCommit_Equal(Boolean.valueOf(CDef.Flg.False.code()));
    }

    protected void doSetIsAvailableCommit_Equal(Boolean isAvailableCommit) {
        regIsAvailableCommit(CK_EQ, isAvailableCommit);
    }
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setIsAvailableGuardSameTarget_Equal_AsFlg(CDef.Flg cdef) {
        doSetIsAvailableGuardSameTarget_Equal(cdef != null ? Boolean.valueOf(cdef.code()) : null);
    }
     ...
     * はい: 有効を示す
     */
    public void setIsAvailableGuardSameTarget_Equal_True() {
        doSetIsAvailableGuardSameTarget_Equal(Boolean.valueOf(CDef.Flg.True.code()));
    }
     ...
     * いいえ: 無効を示す
     */
    public void setIsAvailableGuardSameTarget_Equal_False() {
        doSetIsAvailableGuardSameTarget_Equal(Boolean.valueOf(CDef.Flg.False.code()));
    }

    protected void doSetIsAvailableGuardSameTarget_Equal(Boolean isAvailableGuardSameTarget) {
        regIsAvailableGuardSameTarget(CK_EQ, isAvailableGuardSameTarget);
    }
     ...
     * @param isAvailableAction The value of isAvailableAction as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setIsAvailableAction_Equal(Boolean isAvailableAction) {
        regIsAvailableAction(CK_EQ, isAvailableAction);
    }
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setIsAvailableAction_Equal_AsFlg(CDef.Flg cdef) {
        doSetIsAvailableAction_Equal(cdef != null ? Boolean.valueOf(cdef.code()) : null);
    }
     ...
     * はい: 有効を示す
     */
    public void setIsAvailableAction_Equal_True() {
        doSetIsAvailableAction_Equal(Boolean.valueOf(CDef.Flg.True.code()));
    }
     ...
     * いいえ: 無効を示す
     */
    public void setIsAvailableAction_Equal_False() {
        doSetIsAvailableAction_Equal(Boolean.valueOf(CDef.Flg.False.code()));
    }

    protected void doSetIsAvailableAction_Equal(Boolean isAvailableAction) {
        regIsAvailableAction(CK_EQ, isAvailableAction);
    }

    protected void regIsAvailableAction(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueIsAvailableAction(), "IS_AVAILABLE_ACTION"); }
    protected abstract ConditionValue xgetCValueIsAvailableAction();
     ...
     * @param isReincarnationSkillAll The value of isReincarnationSkillAll as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setIsReincarnationSkillAll_Equal(Boolean isReincarnationSkillAll) {
        regIsReincarnationSkillAll(CK_EQ, isReincarnationSkillAll);
    }
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setIsReincarnationSkillAll_Equal_AsFlg(CDef.Flg cdef) {
        doSetIsReincarnationSkillAll_Equal(cdef != null ? Boolean.valueOf(cdef.code()) : null);
    }
     ...
     * はい: 有効を示す
     */
    public void setIsReincarnationSkillAll_Equal_True() {
        doSetIsReincarnationSkillAll_Equal(Boolean.valueOf(CDef.Flg.True.code()));
    }
     ...
     * いいえ: 無効を示す
     */
    public void setIsReincarnationSkillAll_Equal_False() {
        doSetIsReincarnationSkillAll_Equal(Boolean.valueOf(CDef.Flg.False.code()));
    }

    protected void doSetIsReincarnationSkillAll_Equal(Boolean isReincarnationSkillAll) {
        regIsReincarnationSkillAll(CK_EQ, isReincarnationSkillAll);
    }

    protected void regIsReincarnationSkillAll(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueIsReincarnationSkillAll(), "IS_REINCARNATION_SKILL_ALL"); }
    protected abstract ConditionValue xgetCValueIsReincarnationSkillAll();
