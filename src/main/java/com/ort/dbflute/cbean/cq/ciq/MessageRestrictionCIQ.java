...
public class MessageRestrictionCIQ extends AbstractBsMessageRestrictionCQ {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected BsMessageRestrictionCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MessageRestrictionCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsMessageRestrictionCQ myCQ) {
    ...
    public String keepScalarCondition(MessageRestrictionCQ sq)
    ...
    protected String xinCB() { return MessageRestrictionCB.class.getName(); }
    protected String xinCQ() { return MessageRestrictionCQ.class.getName(); }
}
