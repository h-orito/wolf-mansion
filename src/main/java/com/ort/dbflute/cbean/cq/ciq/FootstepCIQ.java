...
public class FootstepCIQ extends AbstractBsFootstepCQ {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected BsFootstepCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public FootstepCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsFootstepCQ myCQ) {
    ...
    public String keepScalarCondition(FootstepCQ sq)
    ...
    protected String xinCB() { return FootstepCB.class.getName(); }
    protected String xinCQ() { return FootstepCQ.class.getName(); }
}
