...
import com.ort.dbflute.cbean.cq.bs.BsCampAllocationCQ;

/**
 * The condition-query of CAMP_ALLOCATION.
 * <p>
 ...
 */
public class CampAllocationCQ extends BsCampAllocationCQ {
     ...
     */
    public CampAllocationCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
