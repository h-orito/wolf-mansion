...
public class BsCampAllocationCQ extends AbstractBsCampAllocationCQ {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected CampAllocationCIQ _inlineQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsCampAllocationCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public CampAllocationCIQ inline() {
        if (_inlineQuery == null) { _inlineQuery = xcreateCIQ(); }
        _inlineQuery.xsetOnClause(false); return _inlineQuery;
    }

    protected CampAllocationCIQ xcreateCIQ() {
        CampAllocationCIQ ciq = xnewCIQ();
        ciq.xsetBaseCB(_baseCB);
        return ciq;
    }

    protected CampAllocationCIQ xnewCIQ() {
        return new CampAllocationCIQ(xgetReferrerQuery(), xgetSqlClause(), xgetAliasName(), xgetNestLevel(), this);
    }
     ...
     */
    public CampAllocationCIQ on() {
        if (isBaseQuery()) { throw new IllegalConditionBeanOperationException("OnClause for local table is unavailable!"); }
        CampAllocationCIQ inlineQuery = inline(); inlineQuery.xsetOnClause(true); return inlineQuery;
    }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_MinNum_Asc() { regOBA("MIN_NUM"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_MinNum_Desc() { regOBD("MIN_NUM"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_MaxNum_Asc() { regOBA("MAX_NUM"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_MaxNum_Desc() { regOBD("MAX_NUM"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_Allocation_Asc() { regOBA("ALLOCATION"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_RegisterDatetime_Asc() { regOBA("REGISTER_DATETIME"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_RegisterDatetime_Desc() { regOBD("REGISTER_DATETIME"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_RegisterTrace_Asc() { regOBA("REGISTER_TRACE"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_RegisterTrace_Desc() { regOBD("REGISTER_TRACE"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_UpdateDatetime_Asc() { regOBA("UPDATE_DATETIME"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_UpdateDatetime_Desc() { regOBD("UPDATE_DATETIME"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_UpdateTrace_Asc() { regOBA("UPDATE_TRACE"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addOrderBy_UpdateTrace_Desc() { regOBD("UPDATE_TRACE"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addSpecifiedDerivedOrderBy_Asc(String aliasName) { registerSpecifiedDerivedOrderBy_Asc(aliasName); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCampAllocationCQ addSpecifiedDerivedOrderBy_Desc(String aliasName) { registerSpecifiedDerivedOrderBy_Desc(aliasName); return this; }

    // ===================================================================================
    //                                                                         Union Query
    //                                                                         ===========
    public void reflectRelationOnUnionQuery(ConditionQuery bqs, ConditionQuery uqs) {
        CampAllocationCQ bq = (CampAllocationCQ)bqs;
        CampAllocationCQ uq = (CampAllocationCQ)uqs;
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, CampAllocationCQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(CampAllocationCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       Very Internal
    //                                                                       =============
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xCB() { return CampAllocationCB.class.getName(); }
    protected String xCQ() { return CampAllocationCQ.class.getName(); }
