...
public class BsMessageRestrictionCB extends AbstractConditionBean {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected MessageRestrictionCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMessageRestrictionCB() {
    ...
    public MessageRestrictionCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MessageRestrictionCQ doGetConditionQuery() {
    ...
    protected MessageRestrictionCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MessageRestrictionCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MessageRestrictionCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MessageRestrictionCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MessageRestrictionCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void unionAll(UnionQuery<MessageRestrictionCB> unionCBLambda) {
        final MessageRestrictionCB cb = new MessageRestrictionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MessageRestrictionCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     ... = <span style="color: #553000">messageRestriction</span>.<span style="color: #CC4747">getMessageType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">messageRestriction</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">messageRestriction</span>.<span style="color: #CC4747">getVillage()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     */
    public MessageRestrictionCB dreamCruiseCB() {
        MessageRestrictionCB cb = new MessageRestrictionCB();
        cb.xsetupForDreamCruise((MessageRestrictionCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MessageRestrictionCB> columnQuery(final SpecifyQuery<MessageRestrictionCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MessageRestrictionCB xcreateColumnQueryCB() {
        MessageRestrictionCB cb = new MessageRestrictionCB();
        cb.xsetupForColumnQuery((MessageRestrictionCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MessageRestrictionCB> orCBLambda) {
        xorSQ((MessageRestrictionCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MessageRestrictionCB> andCBLambda) {
        xorSQAP((MessageRestrictionCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MessageRestrictionCB cb;
        if (mainCB != null) {
            cb = (MessageRestrictionCB)mainCB;
        } else {
            cb = new MessageRestrictionCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MessageRestrictionCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MessageRestrictionCQ.class.getName(); }
