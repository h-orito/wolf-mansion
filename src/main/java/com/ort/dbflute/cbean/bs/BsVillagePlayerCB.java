...
public class BsVillagePlayerCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<VillagePlayerCQ> {
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MessageCB, VillagePlayerCQ> derivedMessageByToVillagePlayerId() {
            assertDerived("messageByToVillagePlayerIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MessageCB> sq, VillagePlayerCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMessageByToVillagePlayerIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from MESSAGE where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MessageCB, VillagePlayerCQ> derivedMessageByVillagePlayerId() {
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<VillagePlayerDeadHistoryCB, VillagePlayerCQ> derivedVillagePlayerDeadHistory() {
            assertDerived("villagePlayerDeadHistoryList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<VillagePlayerDeadHistoryCB> sq, VillagePlayerCQ cq, String al, DerivedReferrerOption op)
         ...
         *     historyCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     historyCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, VillagePlayerRoomHistory.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<VillagePlayerRoomHistoryCB, VillagePlayerCQ> derivedVillagePlayerRoomHistory() {
            assertDerived("villagePlayerRoomHistoryList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<VillagePlayerRoomHistoryCB> sq, VillagePlayerCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveVillagePlayerRoomHistoryList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<VillagePlayerSkillHistoryCB, VillagePlayerCQ> derivedVillagePlayerSkillHistory() {
            assertDerived("villagePlayerSkillHistoryList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<VillagePlayerSkillHistoryCB> sq, VillagePlayerCQ cq, String al, DerivedReferrerOption op)
