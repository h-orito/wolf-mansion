...
public class BsCharaImageCB extends AbstractConditionBean {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected CharaImageCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsCharaImageCB() {
     ...
     */
    public CharaImageCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return doGetConditionQuery();
    }

    public CharaImageCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected CharaImageCQ doGetConditionQuery() {
    ...
    protected CharaImageCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected CharaImageCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        CharaImageCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected CharaImageCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new CharaImageCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<CharaImageCB> unionCBLambda) {
        final CharaImageCB cb = new CharaImageCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final CharaImageCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<CharaImageCB> unionCBLambda) {
        final CharaImageCB cb = new CharaImageCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final CharaImageCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">charaImage</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">charaImage</span>.<span style="color: #CC4747">getFaceType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<CharaImageCQ> {
        protected CharaCB.HpSpecification _chara;
        protected FaceTypeCB.HpSpecification _faceType;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<CharaImageCQ> qyCall
     ...
     */
    public CharaImageCB dreamCruiseCB() {
        CharaImageCB cb = new CharaImageCB();
        cb.xsetupForDreamCruise((CharaImageCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<CharaImageCB> columnQuery(final SpecifyQuery<CharaImageCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected CharaImageCB xcreateColumnQueryCB() {
        CharaImageCB cb = new CharaImageCB();
        cb.xsetupForColumnQuery((CharaImageCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<CharaImageCB> orCBLambda) {
        xorSQ((CharaImageCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<CharaImageCB> andCBLambda) {
        xorSQAP((CharaImageCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final CharaImageCB cb;
        if (mainCB != null) {
            cb = (CharaImageCB)mainCB;
        } else {
            cb = new CharaImageCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return CharaImageCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return CharaImageCQ.class.getName(); }
