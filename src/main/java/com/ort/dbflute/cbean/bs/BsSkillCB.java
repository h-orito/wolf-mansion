...
public class BsSkillCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<SkillCQ> {
         ...
         */
        public HpSDRFunction<MessageRestrictionCB, SkillCQ> derivedMessageRestriction() {
            assertDerived("messageRestrictionList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MessageRestrictionCB> sq, SkillCQ cq, String al, DerivedReferrerOption op)
