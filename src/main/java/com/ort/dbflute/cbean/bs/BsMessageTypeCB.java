...
public class BsMessageTypeCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MessageTypeCQ> {
         ...
         */
        public HpSDRFunction<MessageCB, MessageTypeCQ> derivedMessage() {
            assertDerived("messageList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MessageCB> sq, MessageTypeCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MessageRestrictionCB, MessageTypeCQ> derivedMessageRestriction() {
