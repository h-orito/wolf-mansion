...
public abstract class BsVillageDayBhv extends AbstractBehaviorWritable<VillageDay, VillageDayCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">villageDayBhv</span>.<span style="color: #CC4747">loadFootstep</span>(<span style="color: #553000">villageDayList</span>, <span style="color: #553000">footstepCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Footstep> loadFootstep(List<VillageDay> villageDayList, ReferrerConditionSetupper<FootstepCB> refCBLambda) {
        xassLRArg(villageDayList, refCBLambda);
        return doLoadFootstep(villageDayList, new LoadReferrerOption<FootstepCB, Footstep>().xinit(refCBLambda));
    }
     ...
     * FOOTSTEP by VILLAGE_ID, DAY, named 'footstepList'.
     * <pre>
     * <span style="color: #0000C0">villageDayBhv</span>.<span style="color: #CC4747">loadFootstep</span>(<span style="color: #553000">villageDay</span>, <span style="color: #553000">footstepCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">footstepCB</span>.setupSelect...
     *     <span style="color: #553000">footstepCB</span>.query().set...
     *     <span style="color: #553000">footstepCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">villageDay</span>.<span style="color: #CC4747">getFootstepList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Footstep> loadFootstep(VillageDay villageDay, ReferrerConditionSetupper<FootstepCB> refCBLambda) {
        xassLRArg(villageDay, refCBLambda);
        return doLoadFootstep(xnewLRLs(villageDay), new LoadReferrerOption<FootstepCB, Footstep>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Footstep> doLoadFootstep(List<VillageDay> villageDayList, LoadReferrerOption<FootstepCB, Footstep> option) {
        return helpLoadReferrerInternally(villageDayList, option, "footstepList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">villageDayBhv</span>.<span style="color: #CC4747">loadMessage</span>(<span style="color: #553000">villageDayList</span>, <span style="color: #553000">messageCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Message> loadMessage(List<VillageDay> villageDayList, ReferrerConditionSetupper<MessageCB> refCBLambda) {
        xassLRArg(villageDayList, refCBLambda);
        return doLoadMessage(villageDayList, new LoadReferrerOption<MessageCB, Message>().xinit(refCBLambda));
    }
     ...
     * MESSAGE by VILLAGE_ID, DAY, named 'messageList'.
     * <pre>
     * <span style="color: #0000C0">villageDayBhv</span>.<span style="color: #CC4747">loadMessage</span>(<span style="color: #553000">villageDay</span>, <span style="color: #553000">messageCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">messageCB</span>.setupSelect...
     *     <span style="color: #553000">messageCB</span>.query().set...
     *     <span style="color: #553000">messageCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">villageDay</span>.<span style="color: #CC4747">getMessageList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Message> loadMessage(VillageDay villageDay, ReferrerConditionSetupper<MessageCB> refCBLambda) {
        xassLRArg(villageDay, refCBLambda);
        return doLoadMessage(xnewLRLs(villageDay), new LoadReferrerOption<MessageCB, Message>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Message> doLoadMessage(List<VillageDay> villageDayList, LoadReferrerOption<MessageCB, Message> option) {
        return helpLoadReferrerInternally(villageDayList, option, "messageList");
    }
