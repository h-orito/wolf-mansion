...
public abstract class BsCharaGroupBhv extends AbstractBehaviorWritable<CharaGroup, CharaGroupCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">charaGroupBhv</span>.<span style="color: #CC4747">loadVillageCharaGroup</span>(<span style="color: #553000">charaGroupList</span>, <span style="color: #553000">groupCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<VillageCharaGroup> loadVillageCharaGroup(List<CharaGroup> charaGroupList, ReferrerConditionSetupper<VillageCharaGroupCB> refCBLambda) {
        xassLRArg(charaGroupList, refCBLambda);
        return doLoadVillageCharaGroup(charaGroupList, new LoadReferrerOption<VillageCharaGroupCB, VillageCharaGroup>().xinit(refCBLambda));
    }
     ...
     * VILLAGE_CHARA_GROUP by CHARA_GROUP_ID, named 'villageCharaGroupList'.
     * <pre>
     * <span style="color: #0000C0">charaGroupBhv</span>.<span style="color: #CC4747">loadVillageCharaGroup</span>(<span style="color: #553000">charaGroup</span>, <span style="color: #553000">groupCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">groupCB</span>.setupSelect...
     *     <span style="color: #553000">groupCB</span>.query().set...
     *     <span style="color: #553000">groupCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">charaGroup</span>.<span style="color: #CC4747">getVillageCharaGroupList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<VillageCharaGroup> loadVillageCharaGroup(CharaGroup charaGroup, ReferrerConditionSetupper<VillageCharaGroupCB> refCBLambda) {
        xassLRArg(charaGroup, refCBLambda);
        return doLoadVillageCharaGroup(xnewLRLs(charaGroup), new LoadReferrerOption<VillageCharaGroupCB, VillageCharaGroup>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<VillageCharaGroup> doLoadVillageCharaGroup(List<CharaGroup> charaGroupList, LoadReferrerOption<VillageCharaGroupCB, VillageCharaGroup> option) {
        return helpLoadReferrerInternally(charaGroupList, option, "villageCharaGroupList");
    }
