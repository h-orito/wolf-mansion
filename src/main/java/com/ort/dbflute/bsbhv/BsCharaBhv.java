...
public abstract class BsCharaBhv extends AbstractBehaviorWritable<Chara, CharaCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">charaBhv</span>.<span style="color: #CC4747">loadFootstep</span>(<span style="color: #553000">charaList</span>, <span style="color: #553000">footstepCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (Chara chara : <span style="color: #553000">charaList</span>) {
     *     ... = chara.<span style="color: #CC4747">getFootstepList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Footstep> loadFootstep(List<Chara> charaList, ReferrerConditionSetupper<FootstepCB> refCBLambda) {
        xassLRArg(charaList, refCBLambda);
        return doLoadFootstep(charaList, new LoadReferrerOption<FootstepCB, Footstep>().xinit(refCBLambda));
    }
     ...
     * FOOTSTEP by CHARA_ID, named 'footstepList'.
     * <pre>
     * <span style="color: #0000C0">charaBhv</span>.<span style="color: #CC4747">loadFootstep</span>(<span style="color: #553000">chara</span>, <span style="color: #553000">footstepCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">footstepCB</span>.setupSelect...
     *     <span style="color: #553000">footstepCB</span>.query().set...
     *     <span style="color: #553000">footstepCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">chara</span>.<span style="color: #CC4747">getFootstepList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Footstep> loadFootstep(Chara chara, ReferrerConditionSetupper<FootstepCB> refCBLambda) {
        xassLRArg(chara, refCBLambda);
        return doLoadFootstep(xnewLRLs(chara), new LoadReferrerOption<FootstepCB, Footstep>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Footstep> doLoadFootstep(List<Chara> charaList, LoadReferrerOption<FootstepCB, Footstep> option) {
        return helpLoadReferrerInternally(charaList, option, "footstepList");
    }
