...
public abstract class BsMessageBhv extends AbstractBehaviorWritable<Message, MessageCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<Message> selectByPK(Integer messageId) {
        return facadeSelectByPK(messageId);
    }

    protected OptionalEntity<Message> facadeSelectByPK(Integer messageId) {
        return doSelectOptionalByPK(messageId, typeOfSelectedEntity());
    }

    protected <ENTITY extends Message> ENTITY doSelectByPK(Integer messageId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(messageId), tp);
    }

    protected <ENTITY extends Message> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer messageId, Class<? extends ENTITY> tp) {
     ...
     */
    public List<MessageType> pulloutMessageType(List<Message> messageList)
    { return helpPulloutInternally(messageList, "messageType"); }
     ...
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<Player> pulloutPlayer(List<Message> messageList)
