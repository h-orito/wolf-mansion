...
public abstract class BsVillagePlayerBhv extends AbstractBehaviorWritable<VillagePlayer, VillagePlayerCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<VillagePlayer> selectByUniqueOf(Integer villageId, Integer playerId) {
        return facadeSelectByUniqueOf(villageId, playerId);
    }

    protected OptionalEntity<VillagePlayer> facadeSelectByUniqueOf(Integer villageId, Integer playerId) {
        return doSelectByUniqueOf(villageId, playerId, typeOfSelectedEntity());
    }

    protected <ENTITY extends VillagePlayer> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer villageId, Integer playerId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(villageId, playerId), tp), villageId, playerId);
    }

    protected VillagePlayerCB xprepareCBAsUniqueOf(Integer villageId, Integer playerId) {
        assertObjectNotNull("villageId", villageId);assertObjectNotNull("playerId", playerId);
        return newConditionBean().acceptUniqueOf(villageId, playerId);
    }
