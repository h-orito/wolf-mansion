...
public class MessageTypeDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((MessageType)et).getMessageTypeCode(), (et, vl) -> ((MessageType)et).setMessageTypeCode((String)vl), "messageTypeCode");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMessageTypeCode = cci("MESSAGE_TYPE_CODE", "MESSAGE_TYPE_CODE", null, null, String.class, "messageTypeCode", null, true, false, true, "VARCHAR", 10, 0, null, null, false, null, null, null, "messageList", null, false);
