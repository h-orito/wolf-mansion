...
public abstract class BsFootstep extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
     ...
     */
    public String getFootstepRoomNumbers() {
        checkSpecifiedProperty("footstepRoomNumbers");
        return convertEmptyToNull(_footstepRoomNumbers);
    }
     ...
     */
    public void setFootstepRoomNumbers(String footstepRoomNumbers) {
        registerModifiedProperty("footstepRoomNumbers");
        _footstepRoomNumbers = footstepRoomNumbers;
    }
