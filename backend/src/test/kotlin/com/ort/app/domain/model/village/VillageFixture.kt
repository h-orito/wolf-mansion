...
fun createPrologueVillage(): Village =
    Village(
        id = 1,
        name = "village name",
...
fun createDay1Village(organize: String = "村狼狼狼魔狐賢導狩共共霊霊霊霊霊霊"): Village =
    Village(
        id = 1,
        name = "village name",
        createPlayerName = "creator name",
        ...
        participants =
            VillageParticipants(
                ...
                list =
                    organize.toCharArray().mapIndexed { index, shortname ->
...
fun createVillageDay(day: Int): VillageDay =
    VillageDay(
        day = day,
        dayChangeDatetime = LocalDateTime.now().plusDays(1L),
    )

fun createVillageSetting(organize: String = "村狼狼狼魔狐賢導狩共共霊霊霊霊霊霊"): VillageSetting =
    VillageSetting(
        chara =
            VillageCharaSetting(
...
fun createVillageRule(): VillageRule =
    VillageRule(
        isOpenVote = false,
        ...
        secretSayRange = SecretSayRange(CDef.AllowedSecretSay.なし),
...
fun createVillageOrganize(organize: String): VillageOrganize =
    VillageOrganize(
