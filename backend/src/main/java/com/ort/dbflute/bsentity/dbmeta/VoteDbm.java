...
public class VoteDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnVoteCharaId = cci("VOTE_CHARA_ID", "VOTE_CHARA_ID", null, null, Integer.class, "voteCharaId", null, false, false, true, "INT UNSIGNED", 10, 0, null, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignVillageDay() {
        ...
        return cfi("FK_VOTE_VILLAGE_DAY", "villageDay", this, VillageDayDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "voteList", false);
    }
