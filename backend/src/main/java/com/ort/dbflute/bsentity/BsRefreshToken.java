...
public abstract class BsRefreshToken extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected java.time.LocalDateTime _expiresAt;
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_expiresAt));
        sb.append(dm).append(xfND(_revoked));
    ...
    /**
     * [get] EXPIRES_AT: {NotNull, DATETIME(19)} <br>
     * 有効期限
     * @return The value of the column 'EXPIRES_AT'. (basically NotNull if selected: for the constraint)
     */
    public java.time.LocalDateTime getExpiresAt() {
        checkSpecifiedProperty("expiresAt");
        return _expiresAt;
    }

    /**
     * [set] EXPIRES_AT: {NotNull, DATETIME(19)} <br>
     * 有効期限
     * @param expiresAt The value of the column 'EXPIRES_AT'. (basically NotNull if update: for the constraint)
     */
    public void setExpiresAt(java.time.LocalDateTime expiresAt) {
        registerModifiedProperty("expiresAt");
        _expiresAt = expiresAt;
    }

    /**
     * [get] REVOKED: {NotNull, BIT, default=[0]} <br>
     * 失効済みか
     * @return The value of the column 'REVOKED'. (basically NotNull if selected: for the constraint)
     */
    public Boolean getRevoked() {
        checkSpecifiedProperty("revoked");
        return _revoked;
    }

    /**
     * [set] REVOKED: {NotNull, BIT, default=[0]} <br>
     * 失効済みか
     * @param revoked The value of the column 'REVOKED'. (basically NotNull if update: for the constraint)
     */
    public void setRevoked(Boolean revoked) {
        registerModifiedProperty("revoked");
        _revoked = revoked;
    }
