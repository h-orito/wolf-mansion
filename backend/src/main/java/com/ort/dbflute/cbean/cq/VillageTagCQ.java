...
import com.ort.dbflute.cbean.cq.bs.BsVillageTagCQ;

/**
 * The condition-query of VILLAGE_TAG.
 * <p>
 ...
 */
public class VillageTagCQ extends BsVillageTagCQ {
     ...
     */
    public VillageTagCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
