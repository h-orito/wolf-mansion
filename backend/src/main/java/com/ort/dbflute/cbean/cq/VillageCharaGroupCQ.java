...
import com.ort.dbflute.cbean.cq.bs.BsVillageCharaGroupCQ;

/**
 * The condition-query of VILLAGE_CHARA_GROUP.
 * <p>
 ...
 */
public class VillageCharaGroupCQ extends BsVillageCharaGroupCQ {
     ...
     */
    public VillageCharaGroupCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
