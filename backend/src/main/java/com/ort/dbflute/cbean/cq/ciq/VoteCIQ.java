...
public class VoteCIQ extends AbstractBsVoteCQ {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected BsVoteCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public VoteCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsVoteCQ myCQ) {
    ...
    protected String xinCB() { return VoteCB.class.getName(); }
    protected String xinCQ() { return VoteCQ.class.getName(); }
}
