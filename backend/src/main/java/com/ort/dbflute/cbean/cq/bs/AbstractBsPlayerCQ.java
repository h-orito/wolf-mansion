...
public abstract class AbstractBsPlayerCQ extends AbstractConditionQuery {
     ...
     * {exists (select PLAYER_ID from analyzer_memo where ...)} <br>
     * analyzer_memo by PLAYER_ID, named 'analyzerMemoAsOne'.
     * <pre>
    ...
    public void existsAnalyzerMemo(SubQuery<AnalyzerMemoCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPlayerId_ExistsReferrer_AnalyzerMemoList(cb.query());
        registerExistsReferrer(cb.query(), "PLAYER_ID", "PLAYER_ID", pp, "analyzerMemoList");
    }
    public abstract String keepPlayerId_ExistsReferrer_AnalyzerMemoList(AnalyzerMemoCQ sq);
    ...
    public void existsMessage(SubQuery<MessageCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPlayerId_ExistsReferrer_MessageList(cb.query());
        registerExistsReferrer(cb.query(), "PLAYER_ID", "PLAYER_ID", pp, "messageList");
    }
    public abstract String keepPlayerId_ExistsReferrer_MessageList(MessageCQ sq);

    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select PLAYER_ID from player_favorite_chara where ...)} <br>
     * player_favorite_chara by PLAYER_ID, named 'playerFavoriteCharaAsOne'.
     * <pre>
    ...
    public void existsPlayerFavoriteChara(SubQuery<PlayerFavoriteCharaCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPlayerId_ExistsReferrer_PlayerFavoriteCharaList(cb.query());
        registerExistsReferrer(cb.query(), "PLAYER_ID", "PLAYER_ID", pp, "playerFavoriteCharaList");
    }
    public abstract String keepPlayerId_ExistsReferrer_PlayerFavoriteCharaList(PlayerFavoriteCharaCQ sq);
     ...
     * {not exists (select PLAYER_ID from analyzer_memo where ...)} <br>
     * analyzer_memo by PLAYER_ID, named 'analyzerMemoAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of PlayerId_NotExistsReferrer_AnalyzerMemoList for 'not exists'. (NotNull)
     */
    public void notExistsAnalyzerMemo(SubQuery<AnalyzerMemoCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        AnalyzerMemoCB cb = new AnalyzerMemoCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPlayerId_NotExistsReferrer_AnalyzerMemoList(cb.query());
        registerNotExistsReferrer(cb.query(), "PLAYER_ID", "PLAYER_ID", pp, "analyzerMemoList");
    }
    public abstract String keepPlayerId_NotExistsReferrer_AnalyzerMemoList(AnalyzerMemoCQ sq);
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of PlayerId_NotExistsReferrer_MessageList for 'not exists'. (NotNull)
     */
    public void notExistsMessage(SubQuery<MessageCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MessageCB cb = new MessageCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPlayerId_NotExistsReferrer_MessageList(cb.query());
        registerNotExistsReferrer(cb.query(), "PLAYER_ID", "PLAYER_ID", pp, "messageList");
    }
    public abstract String keepPlayerId_NotExistsReferrer_MessageList(MessageCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select PLAYER_ID from player_favorite_chara where ...)} <br>
     * player_favorite_chara by PLAYER_ID, named 'playerFavoriteCharaAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of PlayerId_NotExistsReferrer_PlayerFavoriteCharaList for 'not exists'. (NotNull)
     */
    public void notExistsPlayerFavoriteChara(SubQuery<PlayerFavoriteCharaCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        PlayerFavoriteCharaCB cb = new PlayerFavoriteCharaCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPlayerId_NotExistsReferrer_PlayerFavoriteCharaList(cb.query());
        registerNotExistsReferrer(cb.query(), "PLAYER_ID", "PLAYER_ID", pp, "playerFavoriteCharaList");
    }
    public abstract String keepPlayerId_NotExistsReferrer_PlayerFavoriteCharaList(PlayerFavoriteCharaCQ sq);
    ...
    public void xsderiveAnalyzerMemoList(String fn, SubQuery<AnalyzerMemoCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepPlayerId_SpecifyDerivedReferrer_AnalyzerMemoList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "PLAYER_ID", "PLAYER_ID", pp, "analyzerMemoList", al, op);
    }
    public abstract String keepPlayerId_SpecifyDerivedReferrer_AnalyzerMemoList(AnalyzerMemoCQ sq);
    ...
    public void xsderiveMessageList(String fn, SubQuery<MessageCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepPlayerId_SpecifyDerivedReferrer_MessageList(cb.query());
    ...
    public void xsderivePlayerFavoriteCharaList(String fn, SubQuery<PlayerFavoriteCharaCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepPlayerId_SpecifyDerivedReferrer_PlayerFavoriteCharaList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "PLAYER_ID", "PLAYER_ID", pp, "playerFavoriteCharaList", al, op);
    }
    public abstract String keepPlayerId_SpecifyDerivedReferrer_PlayerFavoriteCharaList(PlayerFavoriteCharaCQ sq);
    ...
    public void xqderiveAnalyzerMemoList(String fn, SubQuery<AnalyzerMemoCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        AnalyzerMemoCB cb = new AnalyzerMemoCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepPlayerId_QueryDerivedReferrer_AnalyzerMemoList(cb.query()); String prpp = keepPlayerId_QueryDerivedReferrer_AnalyzerMemoListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PLAYER_ID", "PLAYER_ID", sqpp, "analyzerMemoList", rd, vl, prpp, op);
    }
    public abstract String keepPlayerId_QueryDerivedReferrer_AnalyzerMemoList(AnalyzerMemoCQ sq);
    public abstract String keepPlayerId_QueryDerivedReferrer_AnalyzerMemoListParameter(Object vl);
    ...
    public void xqderiveMessageList(String fn, SubQuery<MessageCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MessageCB cb = new MessageCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepPlayerId_QueryDerivedReferrer_MessageList(cb.query()); String prpp = keepPlayerId_QueryDerivedReferrer_MessageListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PLAYER_ID", "PLAYER_ID", sqpp, "messageList", rd, vl, prpp, op);
    }
    ...
    public void xqderivePlayerFavoriteCharaList(String fn, SubQuery<PlayerFavoriteCharaCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        PlayerFavoriteCharaCB cb = new PlayerFavoriteCharaCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepPlayerId_QueryDerivedReferrer_PlayerFavoriteCharaList(cb.query()); String prpp = keepPlayerId_QueryDerivedReferrer_PlayerFavoriteCharaListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PLAYER_ID", "PLAYER_ID", sqpp, "playerFavoriteCharaList", rd, vl, prpp, op);
    }
    public abstract String keepPlayerId_QueryDerivedReferrer_PlayerFavoriteCharaList(PlayerFavoriteCharaCQ sq);
    public abstract String keepPlayerId_QueryDerivedReferrer_PlayerFavoriteCharaListParameter(Object vl);
