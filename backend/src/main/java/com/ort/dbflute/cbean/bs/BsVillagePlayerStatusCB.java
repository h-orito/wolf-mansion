...
public class BsVillagePlayerStatusCB extends AbstractConditionBean {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected VillagePlayerStatusCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsVillagePlayerStatusCB() {
     ...
     * @return this. (NotNull)
     */
    public VillagePlayerStatusCB acceptPK(Integer villagePlayerStatusId) {
        assertObjectNotNull("villagePlayerStatusId", villagePlayerStatusId);
        BsVillagePlayerStatusCB cb = this;
        cb.query().setVillagePlayerStatusId_Equal(villagePlayerStatusId);
        return (VillagePlayerStatusCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_VillagePlayerStatusId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_VillagePlayerStatusId_Desc();
        return this;
    }
     ...
     */
    public VillagePlayerStatusCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public VillagePlayerStatusCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected VillagePlayerStatusCQ doGetConditionQuery() {
    ...
    protected VillagePlayerStatusCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected VillagePlayerStatusCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        VillagePlayerStatusCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected VillagePlayerStatusCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new VillagePlayerStatusCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<VillagePlayerStatusCB> unionCBLambda) {
        final VillagePlayerStatusCB cb = new VillagePlayerStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final VillagePlayerStatusCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<VillagePlayerStatusCB> unionCBLambda) {
        final VillagePlayerStatusCB cb = new VillagePlayerStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final VillagePlayerStatusCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">villagePlayerStatusBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">villagePlayerStatus</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">villagePlayerStatus</span>.<span style="color: #CC4747">getVillagePlayerByToVillagePlayerId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">villagePlayerStatus</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">villagePlayerStatus</span>.<span style="color: #CC4747">getVillagePlayerByVillagePlayerId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     * <pre>
     * <span style="color: #0000C0">villagePlayerStatusBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_VillagePlayerStatusType()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">villagePlayerStatus</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">villagePlayerStatus</span>.<span style="color: #CC4747">getVillagePlayerStatusType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    public void setupSelect_VillagePlayerStatusType() {
        assertSetupSelectPurpose("villagePlayerStatusType");
        if (hasSpecifiedLocalColumn()) {
            specify().columnVillagePlayerStatusCode();
        }
        doSetupSelect(() -> query().queryVillagePlayerStatusType());
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<VillagePlayerStatusCQ> {
        ...
        protected VillagePlayerStatusTypeCB.HpSpecification _villagePlayerStatusType;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<VillagePlayerStatusCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            columnVillagePlayerStatusId(); // PK
            ...
            if (qyCall().qy().hasConditionQueryVillagePlayerStatusType()
                    || qyCall().qy().xgetReferrerQuery() instanceof VillagePlayerStatusTypeCQ) {
                columnVillagePlayerStatusCode(); // FK or one-to-one referrer
            }
        }
        @Override
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public VillagePlayerStatusTypeCB.HpSpecification specifyVillagePlayerStatusType() {
            assertRelation("villagePlayerStatusType");
            if (_villagePlayerStatusType == null) {
                _villagePlayerStatusType = new VillagePlayerStatusTypeCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryVillagePlayerStatusType()
                                    , () -> _qyCall.qy().queryVillagePlayerStatusType())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _villagePlayerStatusType.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryVillagePlayerStatusType()
                      , () -> xsyncQyCall().qy().queryVillagePlayerStatusType()));
                }
            }
         ...
         */
        public HpSDRFunction<VillagePlayerStatusCB, VillagePlayerStatusCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<VillagePlayerStatusCB> sq, VillagePlayerStatusCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public VillagePlayerStatusCB dreamCruiseCB() {
        VillagePlayerStatusCB cb = new VillagePlayerStatusCB();
        cb.xsetupForDreamCruise((VillagePlayerStatusCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<VillagePlayerStatusCB> columnQuery(final SpecifyQuery<VillagePlayerStatusCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected VillagePlayerStatusCB xcreateColumnQueryCB() {
        VillagePlayerStatusCB cb = new VillagePlayerStatusCB();
        cb.xsetupForColumnQuery((VillagePlayerStatusCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<VillagePlayerStatusCB> orCBLambda) {
        xorSQ((VillagePlayerStatusCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<VillagePlayerStatusCB> andCBLambda) {
        xorSQAP((VillagePlayerStatusCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final VillagePlayerStatusCB cb;
        if (mainCB != null) {
            cb = (VillagePlayerStatusCB)mainCB;
        } else {
            cb = new VillagePlayerStatusCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return VillagePlayerStatusCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return VillagePlayerStatusCQ.class.getName(); }
