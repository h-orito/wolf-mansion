...
public class BsRefreshTokenCQ extends AbstractBsRefreshTokenCQ {
    ...
    protected ConditionValue _issuedDatetime;
    public ConditionValue xdfgetIssuedDatetime()
    { if (_issuedDatetime == null) { _issuedDatetime = nCV(); }
      return _issuedDatetime; }
    protected ConditionValue xgetCValueIssuedDatetime() { return xdfgetIssuedDatetime(); }
     ...
     * @return this. (NotNull)
     */
    public BsRefreshTokenCQ addOrderBy_IssuedDatetime_Asc() { regOBA("ISSUED_DATETIME"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsRefreshTokenCQ addOrderBy_IssuedDatetime_Desc() { regOBD("ISSUED_DATETIME"); return this; }

    protected ConditionValue _expiresDatetime;
    public ConditionValue xdfgetExpiresDatetime()
    { if (_expiresDatetime == null) { _expiresDatetime = nCV(); }
      return _expiresDatetime; }
    protected ConditionValue xgetCValueExpiresDatetime() { return xdfgetExpiresDatetime(); }
    ...
    protected ConditionValue _usedDatetime;
    public ConditionValue xdfgetUsedDatetime()
    { if (_usedDatetime == null) { _usedDatetime = nCV(); }
      return _usedDatetime; }
    protected ConditionValue xgetCValueUsedDatetime() { return xdfgetUsedDatetime(); }
     ...
     * @return this. (NotNull)
     */
    public BsRefreshTokenCQ addOrderBy_UsedDatetime_Asc() { regOBA("USED_DATETIME"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsRefreshTokenCQ addOrderBy_UsedDatetime_Desc() { regOBD("USED_DATETIME"); return this; }

    protected ConditionValue _revokedDatetime;
    public ConditionValue xdfgetRevokedDatetime()
    { if (_revokedDatetime == null) { _revokedDatetime = nCV(); }
      return _revokedDatetime; }
    protected ConditionValue xgetCValueRevokedDatetime() { return xdfgetRevokedDatetime(); }
     ...
     * @return this. (NotNull)
     */
    public BsRefreshTokenCQ addOrderBy_RevokedDatetime_Asc() { regOBA("REVOKED_DATETIME"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsRefreshTokenCQ addOrderBy_RevokedDatetime_Desc() { regOBD("REVOKED_DATETIME"); return this; }
