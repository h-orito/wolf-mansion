...
import com.ort.dbflute.cbean.cq.bs.BsWolfAllocationCQ;

/**
 * The condition-query of WOLF_ALLOCATION.
 * <p>
 ...
 */
public class WolfAllocationCQ extends BsWolfAllocationCQ {
     ...
     */
    public WolfAllocationCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
