...
public class SkillSayRestrictionCIQ extends AbstractBsSkillSayRestrictionCQ {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected BsSkillSayRestrictionCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public SkillSayRestrictionCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsSkillSayRestrictionCQ myCQ) {
    ...
    public String keepScalarCondition(SkillSayRestrictionCQ sq)
    ...
    protected String xinCB() { return SkillSayRestrictionCB.class.getName(); }
    protected String xinCQ() { return SkillSayRestrictionCQ.class.getName(); }
}
