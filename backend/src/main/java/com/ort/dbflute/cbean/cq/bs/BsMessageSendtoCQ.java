...
public class BsMessageSendtoCQ extends AbstractBsMessageSendtoCQ {
    ...
    //                                                                               Query
    //                                                                               =====
    protected ConditionValue _messageReplytoId;
    public ConditionValue xdfgetMessageReplytoId()
    { if (_messageReplytoId == null) { _messageReplytoId = nCV(); }
      return _messageReplytoId; }
    protected ConditionValue xgetCValueMessageReplytoId() { return xdfgetMessageReplytoId(); }
     ...
     * @return this. (NotNull)
     */
    public BsMessageSendtoCQ addOrderBy_MessageReplytoId_Asc() { regOBA("MESSAGE_REPLYTO_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMessageSendtoCQ addOrderBy_MessageReplytoId_Desc() { regOBD("MESSAGE_REPLYTO_ID"); return this; }
