...
import com.ort.dbflute.cbean.cq.bs.BsLoginFailureCQ;

/**
 * The condition-query of LOGIN_FAILURE.
 * <p>
 ...
 */
public class LoginFailureCQ extends BsLoginFailureCQ {
     ...
     */
    public LoginFailureCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
