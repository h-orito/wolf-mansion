...
import com.ort.dbflute.cbean.cq.bs.BsOriginalCharaImageCQ;

/**
 * The condition-query of ORIGINAL_CHARA_IMAGE.
 * <p>
 ...
 */
public class OriginalCharaImageCQ extends BsOriginalCharaImageCQ {
     ...
     */
    public OriginalCharaImageCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
