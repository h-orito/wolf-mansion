...
import com.ort.dbflute.cbean.cq.bs.BsOriginalCharaCQ;

/**
 * The condition-query of ORIGINAL_CHARA.
 * <p>
 ...
 */
public class OriginalCharaCQ extends BsOriginalCharaCQ {
     ...
     */
    public OriginalCharaCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
