...
public class BsMessageSendtoCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public MessageSendtoCB acceptPK(Integer messageReplytoId) {
        assertObjectNotNull("messageReplytoId", messageReplytoId);
        BsMessageSendtoCB cb = this;
        cb.query().setMessageReplytoId_Equal(messageReplytoId);
        return (MessageSendtoCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_MessageReplytoId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_MessageReplytoId_Desc();
        return this;
    }
    ...
    //                                                                         SetupSelect
    //                                                                         ===========
    protected MessageNss _nssMessage;
    public MessageNss xdfgetNssMessage() {
        if (_nssMessage == null) { _nssMessage = new MessageNss(null); }
        return _nssMessage;
    }
    /**
     ...
     */
    public MessageNss setupSelect_Message() {
        ...
        { _nssMessage = new MessageNss(query().queryMessage()); }
        return _nssMessage;
    }
