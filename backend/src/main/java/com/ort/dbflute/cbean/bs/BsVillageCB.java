...
public class BsVillageCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<VillageCQ> {
         ...
         */
        public HpSDRFunction<AnalyzerMemoCB, VillageCQ> derivedAnalyzerMemo() {
            assertDerived("analyzerMemoList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<AnalyzerMemoCB> sq, VillageCQ cq, String al, DerivedReferrerOption op)
