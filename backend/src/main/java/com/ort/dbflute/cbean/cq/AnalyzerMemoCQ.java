...
import com.ort.dbflute.cbean.cq.bs.BsAnalyzerMemoCQ;

/**
 * The condition-query of ANALYZER_MEMO.
 * <p>
 ...
 */
public class AnalyzerMemoCQ extends BsAnalyzerMemoCQ {
     ...
     */
    public AnalyzerMemoCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
