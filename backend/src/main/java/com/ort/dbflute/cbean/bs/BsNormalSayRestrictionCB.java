...
/**
 * The base condition-bean of normal_say_restriction.
 * @author DBFlute(AutoGenerator)
 */
public class BsNormalSayRestrictionCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected NormalSayRestrictionCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsNormalSayRestrictionCB() {
     ...
     * @return this. (NotNull)
     */
    public NormalSayRestrictionCB acceptPK(Integer villageId, CDef.Skill skillCode, CDef.MessageType messageTypeCode) {
        ...
        BsNormalSayRestrictionCB cb = this;
        ...
        return (NormalSayRestrictionCB)this;
    }
     ...
     */
    public NormalSayRestrictionCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public NormalSayRestrictionCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected NormalSayRestrictionCQ doGetConditionQuery() {
    ...
    protected NormalSayRestrictionCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected NormalSayRestrictionCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        NormalSayRestrictionCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected NormalSayRestrictionCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new NormalSayRestrictionCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<NormalSayRestrictionCB> unionCBLambda) {
        final NormalSayRestrictionCB cb = new NormalSayRestrictionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final NormalSayRestrictionCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<NormalSayRestrictionCB> unionCBLambda) {
        final NormalSayRestrictionCB cb = new NormalSayRestrictionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final NormalSayRestrictionCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">normalSayRestrictionBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">normalSayRestriction</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">normalSayRestriction</span>.<span style="color: #CC4747">getMessageType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">normalSayRestriction</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">normalSayRestriction</span>.<span style="color: #CC4747">getSkill()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">normalSayRestriction</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">normalSayRestriction</span>.<span style="color: #CC4747">getVillage()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<NormalSayRestrictionCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<NormalSayRestrictionCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "normal_say_restriction"; }
        /**
     ...
     */
    public NormalSayRestrictionCB dreamCruiseCB() {
        NormalSayRestrictionCB cb = new NormalSayRestrictionCB();
        cb.xsetupForDreamCruise((NormalSayRestrictionCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<NormalSayRestrictionCB> columnQuery(final SpecifyQuery<NormalSayRestrictionCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected NormalSayRestrictionCB xcreateColumnQueryCB() {
        NormalSayRestrictionCB cb = new NormalSayRestrictionCB();
        cb.xsetupForColumnQuery((NormalSayRestrictionCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<NormalSayRestrictionCB> orCBLambda) {
        xorSQ((NormalSayRestrictionCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<NormalSayRestrictionCB> andCBLambda) {
        xorSQAP((NormalSayRestrictionCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final NormalSayRestrictionCB cb;
        if (mainCB != null) {
            cb = (NormalSayRestrictionCB)mainCB;
        } else {
            cb = new NormalSayRestrictionCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return NormalSayRestrictionCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return NormalSayRestrictionCQ.class.getName(); }
