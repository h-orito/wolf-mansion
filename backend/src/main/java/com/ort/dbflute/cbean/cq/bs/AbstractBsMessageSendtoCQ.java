...
public abstract class AbstractBsMessageSendtoCQ extends AbstractConditionQuery {
     ...
     * @param messageReplytoId The value of messageReplytoId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setMessageReplytoId_Equal(Integer messageReplytoId) {
        doSetMessageReplytoId_Equal(messageReplytoId);
    }

    protected void doSetMessageReplytoId_Equal(Integer messageReplytoId) {
        regMessageReplytoId(CK_EQ, messageReplytoId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * MESSAGE_REPLYTO_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param messageReplytoId The value of messageReplytoId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMessageReplytoId_NotEqual(Integer messageReplytoId) {
        doSetMessageReplytoId_NotEqual(messageReplytoId);
    }

    protected void doSetMessageReplytoId_NotEqual(Integer messageReplytoId) {
        regMessageReplytoId(CK_NES, messageReplytoId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * MESSAGE_REPLYTO_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param messageReplytoId The value of messageReplytoId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setMessageReplytoId_GreaterThan(Integer messageReplytoId) {
        regMessageReplytoId(CK_GT, messageReplytoId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * MESSAGE_REPLYTO_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param messageReplytoId The value of messageReplytoId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setMessageReplytoId_LessThan(Integer messageReplytoId) {
        regMessageReplytoId(CK_LT, messageReplytoId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * MESSAGE_REPLYTO_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param messageReplytoId The value of messageReplytoId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMessageReplytoId_GreaterEqual(Integer messageReplytoId) {
        regMessageReplytoId(CK_GE, messageReplytoId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * MESSAGE_REPLYTO_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param messageReplytoId The value of messageReplytoId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMessageReplytoId_LessEqual(Integer messageReplytoId) {
        regMessageReplytoId(CK_LE, messageReplytoId);
    }
     ...
     * MESSAGE_REPLYTO_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param minNumber The min number of messageReplytoId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of messageReplytoId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setMessageReplytoId_RangeOf(Integer minNumber, Integer maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setMessageReplytoId_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     */
    protected void setMessageReplytoId_RangeOf(Integer minNumber, Integer maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueMessageReplytoId(), "MESSAGE_REPLYTO_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * MESSAGE_REPLYTO_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param messageReplytoIdList The collection of messageReplytoId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setMessageReplytoId_InScope(Collection<Integer> messageReplytoIdList) {
        doSetMessageReplytoId_InScope(messageReplytoIdList);
    }

    protected void doSetMessageReplytoId_InScope(Collection<Integer> messageReplytoIdList) {
        regINS(CK_INS, cTL(messageReplytoIdList), xgetCValueMessageReplytoId(), "MESSAGE_REPLYTO_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * MESSAGE_REPLYTO_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     * @param messageReplytoIdList The collection of messageReplytoId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setMessageReplytoId_NotInScope(Collection<Integer> messageReplytoIdList) {
        doSetMessageReplytoId_NotInScope(messageReplytoIdList);
    }

    protected void doSetMessageReplytoId_NotInScope(Collection<Integer> messageReplytoIdList) {
        regINS(CK_NINS, cTL(messageReplytoIdList), xgetCValueMessageReplytoId(), "MESSAGE_REPLYTO_ID");
    }
     ...
     * MESSAGE_REPLYTO_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     */
    public void setMessageReplytoId_IsNull() { regMessageReplytoId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * MESSAGE_REPLYTO_ID: {PK, ID, NotNull, INT UNSIGNED(10)}
     */
    public void setMessageReplytoId_IsNotNull() { regMessageReplytoId(CK_ISNN, DOBJ); }

    protected void regMessageReplytoId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueMessageReplytoId(), "MESSAGE_REPLYTO_ID"); }
    protected abstract ConditionValue xgetCValueMessageReplytoId();
    ...
    public void xsmyselfDerive(String fn, SubQuery<MessageSendtoCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "MESSAGE_REPLYTO_ID";
