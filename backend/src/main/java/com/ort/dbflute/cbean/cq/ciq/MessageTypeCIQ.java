...
public class MessageTypeCIQ extends AbstractBsMessageTypeCQ {
    ...
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepMessageTypeCode_SpecifyDerivedReferrer_SkillSayRestrictionList(SkillSayRestrictionCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    ...
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepMessageTypeCode_QueryDerivedReferrer_NormalSayRestrictionListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepMessageTypeCode_QueryDerivedReferrer_SkillSayRestrictionList(SkillSayRestrictionCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepMessageTypeCode_QueryDerivedReferrer_SkillSayRestrictionListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
