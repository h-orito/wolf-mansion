...
import com.ort.dbflute.cbean.cq.bs.BsSkillAllocationCQ;

/**
 * The condition-query of SKILL_ALLOCATION.
 * <p>
 ...
 */
public class SkillAllocationCQ extends BsSkillAllocationCQ {
     ...
     */
    public SkillAllocationCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
