...
public abstract class AbstractBsRefreshTokenCQ extends AbstractConditionQuery {
     ...
     * @param expiresAt The value of expiresAt as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setExpiresAt_Equal(java.time.LocalDateTime expiresAt) {
        regExpiresAt(CK_EQ,  expiresAt);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * EXPIRES_AT: {NotNull, DATETIME(19)}
     * @param expiresAt The value of expiresAt as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setExpiresAt_GreaterThan(java.time.LocalDateTime expiresAt) {
        regExpiresAt(CK_GT,  expiresAt);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * EXPIRES_AT: {NotNull, DATETIME(19)}
     * @param expiresAt The value of expiresAt as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setExpiresAt_LessThan(java.time.LocalDateTime expiresAt) {
        regExpiresAt(CK_LT,  expiresAt);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * EXPIRES_AT: {NotNull, DATETIME(19)}
     * @param expiresAt The value of expiresAt as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setExpiresAt_GreaterEqual(java.time.LocalDateTime expiresAt) {
        regExpiresAt(CK_GE,  expiresAt);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * EXPIRES_AT: {NotNull, DATETIME(19)}
     * @param expiresAt The value of expiresAt as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setExpiresAt_LessEqual(java.time.LocalDateTime expiresAt) {
        regExpiresAt(CK_LE, expiresAt);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * EXPIRES_AT: {NotNull, DATETIME(19)}
     * <pre>e.g. setExpiresAt_FromTo(fromDate, toDate, op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">compareAsDate()</span>);</pre>
     * @param fromDatetime The from-datetime(yyyy/MM/dd HH:mm:ss.SSS) of expiresAt. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param toDatetime The to-datetime(yyyy/MM/dd HH:mm:ss.SSS) of expiresAt. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of from-to. (NotNull)
     */
    public void setExpiresAt_FromTo(java.time.LocalDateTime fromDatetime, java.time.LocalDateTime toDatetime, ConditionOptionCall<FromToOption> opLambda) {
        setExpiresAt_FromTo(fromDatetime, toDatetime, xcFTOP(opLambda));
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * EXPIRES_AT: {NotNull, DATETIME(19)}
     * <pre>e.g. setExpiresAt_FromTo(fromDate, toDate, new <span style="color: #CC4747">FromToOption</span>().compareAsDate());</pre>
     * @param fromDatetime The from-datetime(yyyy/MM/dd HH:mm:ss.SSS) of expiresAt. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param toDatetime The to-datetime(yyyy/MM/dd HH:mm:ss.SSS) of expiresAt. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param fromToOption The option of from-to. (NotNull)
     */
    protected void setExpiresAt_FromTo(java.time.LocalDateTime fromDatetime, java.time.LocalDateTime toDatetime, FromToOption fromToOption) {
        String nm = "EXPIRES_AT"; FromToOption op = fromToOption;
        regFTQ(xfFTHD(fromDatetime, nm, op), xfFTHD(toDatetime, nm, op), xgetCValueExpiresAt(), nm, op);
    }

    protected void regExpiresAt(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueExpiresAt(), "EXPIRES_AT"); }
    protected abstract ConditionValue xgetCValueExpiresAt();

    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. <br>
     * REVOKED: {NotNull, BIT, default=[0]}
     * @param revoked The value of revoked as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setRevoked_Equal(Boolean revoked) {
        regRevoked(CK_EQ, revoked);
    }

    protected void regRevoked(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueRevoked(), "REVOKED"); }
    protected abstract ConditionValue xgetCValueRevoked();
