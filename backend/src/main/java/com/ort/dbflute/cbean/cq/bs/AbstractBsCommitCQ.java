...
public abstract class AbstractBsCommitCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsCommitCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<CommitCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, CommitCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<CommitCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, CommitCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<CommitCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, CommitCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<CommitCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, CommitCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<CommitCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, CommitCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;CommitCB&gt;() {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<CommitCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, CommitCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        CommitCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(CommitCQ sq);

    protected CommitCB xcreateScalarConditionCB() {
        CommitCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected CommitCB xcreateScalarConditionPartitionByCB() {
        CommitCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected CommitCB newMyCB() {
        return new CommitCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return CommitCQ.class.getName(); }
