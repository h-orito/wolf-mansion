...
public class BsCharaCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<CharaCQ> {
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<PlayerFavoriteCharaCB, CharaCQ> derivedPlayerFavoriteChara() {
            assertDerived("playerFavoriteCharaList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<PlayerFavoriteCharaCB> sq, CharaCQ cq, String al, DerivedReferrerOption op)
