...
import com.ort.dbflute.cbean.cq.bs.BsOriginalCharaGroupCQ;

/**
 * The condition-query of ORIGINAL_CHARA_GROUP.
 * <p>
 ...
 */
public class OriginalCharaGroupCQ extends BsOriginalCharaGroupCQ {
     ...
     */
    public OriginalCharaGroupCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
