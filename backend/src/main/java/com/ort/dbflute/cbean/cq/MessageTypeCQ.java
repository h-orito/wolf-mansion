 ...
 */
public class MessageTypeCQ extends BsMessageTypeCQ {
     ...
     */
    public MessageTypeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
