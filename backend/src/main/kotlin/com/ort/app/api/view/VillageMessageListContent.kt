...
data class VillageMessageListContent(
    ...
    companion object {
        private fun mapVillageStatusMessage(
            ...
            if (day != village.latestDay()) {
                null
            } else {
                village.statusMessage(user != null, myself != null)
            }

        private fun mapSuddenlyDeathMessage(
            village: Village,
            votes: Votes,
            day: Int,
        ): String? {
            ...
            val noVoteParticipantList =
                village.participants
                    .filterNotDummy(village.dummyParticipant())
                    .filterNotGone()
                    .filterAlive()
                    .list
                    .filter { votes.filterByCharaId(it.charaId).list.isEmpty() }
        ...
        fun isDispSuddenlyDeathWarnMessage(
            village: Village,
            day: Int,
        ): Boolean =
        ...
        private fun mapCommitStatusMessage(
            village: Village,
            day: Int,
            commits: Commits,
        ): String? {
        ...
        fun isDispCommitMessage(
            village: Village,
            day: Int,
        ): Boolean =
            village.setting.rule.isAvailableCommit &&
                village.status.isProgress() &&
                day == village.latestDay()
        ...
        private fun isRainbow(
            ...
            return abilities
                .filterByDay(message.time.day - 1)
                .filterByType(CDef.AbilityType.虹塗り.toModel())
                .list
                .any { it.targetCharaId == charaId }
        }
        ...
        private fun isLoud(
            ...
            return abilities
                .filterByDay(message.time.day - 1)
                .filterByType(CDef.AbilityType.拡声.toModel())
                .list
                .any { it.targetCharaId == charaId }
        }
    }
