...
class AdminController(
    ...
    private fun leave(
        ...
        val participant =
            villageService.findVillageParticipant(leaveForm.villagePlayerId)
                ?: return "redirect:/village/$villageId#bottom"
    ...
    private fun player(
        @PathVariable villageId: Int,
    ): List<VillageCharaPlayerContent> =
        villagePlayerBhv
            .selectList { cb: VillagePlayerCB ->
    ...
    data class VillageCharaPlayerContent(
