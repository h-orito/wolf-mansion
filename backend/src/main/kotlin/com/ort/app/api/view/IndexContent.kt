...
data class IndexContent(
    ...
    data class IndexVillage(
        ...
        constructor(
            ...
            madori =
                if (village.status.isPrologue()) {
                    "${village.setting.personMin}~${village.setting.personMax}LDK"
                } else if (village.spectators.count > 0) {
                    "${village.participants.count}+${village.spectators.count}LDK"
                } else {
                    "${village.participants.count}LDK"
                },
