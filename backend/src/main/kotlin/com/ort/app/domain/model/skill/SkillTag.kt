...
enum class SkillTag {
    ...
    companion object {
        ...
        fun of(tags: List<String>): List<SkillTag> = tags.mapNotNull { safeValueOf(it) }
        ...
        private fun listOfSkill(predicate: (Skill) -> Boolean): List<Skill> = Skills.all().filter(predicate).list
    }
