...
class TrapDomainService(
    ...
    fun trap(daychange: Daychange): Daychange {
        ...
        village.participants
            .filterBySkill(CDef.Skill.罠師.toModel())
            .list
            .filterNot {
                // 突然死でない限りは発動
                ...
                val ability =
                    daychange.abilities.findYesterday(village, trapper, abilityType)
                        ?: return@forEach
                // 設置された部屋
                val roomNumber =
                    village.participants
    ...
    private fun createSuccessMessage(
        ...
        val message =
            passedParticipants.joinToString(
