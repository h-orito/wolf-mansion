...
class VillageDataSource(
    ...
    override fun updateDummyCharaId(
        id: Int,
        charaId: Int,
    ...
    override fun participate(
        ...
        val vPlayer =
            villagePlayerDataSource.insertVillagePlayer(
                villageId,
                playerId,
                chara,
                charaName,
    ...
    override fun switchParticipate(
        villageId: Int,
        participantId: Int,
        isSpectator: Boolean,
    ): VillageParticipant {
    ...
    override fun changeRequestSkill(
        participant: VillageParticipant,
        first: Skill,
        second: Skill,
    ) = villagePlayerDataSource.changeRequestSkill(participant, first, second)

    override fun changeMemo(
        participant: VillageParticipant,
        memo: String,
    ) = villagePlayerDataSource.changeMemo(participant, memo)

    override fun updateLastAccessDatetime(participant: VillageParticipant) = villagePlayerDataSource.updateLastAccessDatetime(participant)
    ...
    private fun updateVillageDaychangeDifference(
        current: Village,
        changed: Village,
    ) {
